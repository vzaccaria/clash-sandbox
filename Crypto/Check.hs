...
tests :: TestTree
tests = testGroup "Tests" [keySchedule, aes, aesE2E, aesSim]
...
k0  = 0x2b :> 0x7e :> 0x15 :> 0x16 :> 0x28 :> 0xae :> 0xd2 :> 0xa6 :> 0xab :> 0xf7 :> 0x15 :> 0x88 :> 0x09 :> 0xcf :> 0x4f :> 0x3c :> Nil
...
--                              _ ____  _
--   _ __ ___  _   _ _ __   __| / ___|| |_ __ _  __ _  ___  ___
-- | '__/ _ \| | | | '_ \ / _` \___ \| __/ _` |/ _` |/ _ \/ __|
-- | | | (_) | |_| | | | | (_| |___) | || (_| | (_| |  __/\__ \
-- |_|  \___/ \__,_|_| |_|\__,_|____/ \__\__,_|\__, |\___||___/
--                                             |___/
--

-- Page 33 of AES Standard - Appendix B.
-- Trans is used to transform a matrix state in that page to an actual state in memory
i0  = trans $ 0x32 :> 0x88 :> 0x31 :> 0xe0  :> 0x43 :> 0x5a :> 0x31 :> 0x37  :> 0xf6 :> 0x30 :> 0x98 :> 0x07  :> 0xa8 :> 0x8d :> 0xa2 :> 0x34 :> Nil
...
aesE2E = testGroup "HUnit - AES Encrypt - FSM" [
  (testCase "Compute complete round (state+key)"     $ (assertEqual "" (fst (aesMealy i0 c0 (I zs False))) (c1)))
  ]
...
k0' = 0x00 :> 0x01 :> 0x02 :> 0x03 :> 0x04 :> 0x05 :> 0x06 :> 0x07 :> 0x08 :> 0x09 :> 0x0a :> 0x0b :> 0x0c :> 0x0d :> 0x0e :> 0x0f :> Nil
i0' = 0x00 :> 0x11 :> 0x22 :> 0x33 :> 0x44 :> 0x55 :> 0x66 :> 0x77 :> 0x88 :> 0x99 :> 0xaa :> 0xbb :> 0xcc :> 0xdd :> 0xee :> 0xff :> Nil
f0' = 0x69 :> 0xc4 :> 0xe0 :> 0xd8 :> 0x6a :> 0x7b :> 0x04 :> 0x30 :> 0xd8 :> 0xcd :> 0xb7 :> 0x80 :> 0x70 :> 0xb4 :> 0xc5 :> 0x5a :> Nil


testEntity text = mealy (aesMealy k0') (aesInitState, (aesInitState, 0)) text

--
aesSim = testGroup "HUnit - AES Encrypt - FSM" [
  (testCase "Compute complete cypher encode"  $
    let result = (take 14 $ (simulate testEntity e2eSimData))
        datum = result !! 12
        datum' = (O f0' True) in
        assertEqual "" datum datum')
  ]
